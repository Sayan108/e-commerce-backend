...
class UserModel {
  ...
  /* ===========================
      PUBLIC FIELDS ONLY
=========================== */
  static get USER_PUBLIC_FIELDS() {
    return "_id name email role phone cartItemCount profilePicture createdAt";
  }

  /* ===========================
      CREATE USER
  ============================ */
  static async createUser({ email, password, role = Roles.CUSTOMER }) {
    ...
    if (cfg.db.type === dbs.MONGODB) {
      ...
      return UserM.findById(user._id).select(this.USER_PUBLIC_FIELDS).lean();
    }
...
=========================== */
  static async findById(id) {
    if (cfg.db.type === dbs.MONGODB) {
      return UserM.findById(id).select(this.USER_PUBLIC_FIELDS).lean();
    }
